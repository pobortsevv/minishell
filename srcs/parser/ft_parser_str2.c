...
/*   Updated: 2021/03/23 11:48:49 by mlaureen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_in_cycle_a(char **res, char *temp, int *j)
{
	char	*t1;
...
char		*ft_res_arg(char *str, int *flag)
{
	...
	{
		ft_is_a(str, flag, &i);
		if (checkbit(*flag, SLASH_1) &&  checkbit(*flag, DOUBLE_Q)  &&
